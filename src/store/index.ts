...
class Store
{
    ...
    constructor ()
    {
        // define compose enhancers function
        this.compose = window[REDUX_DEVTOOLS] || compose;
    }
     ...
     */
    create (reducer: Reducer, middlewares: Middleware[], enhancer?): IStore
    {
        // set enhancers list
        let enhancers = new Array();
